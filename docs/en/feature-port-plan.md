...
- **Status:** F1–F4 done; F5–F6 pending  
- **Date:** 2026-07-24  
...
Updates the roadmap in [refactoring-plan.md](./refactoring-plan.md): pipeline and GUI are done; F1–F4 done; next focus — F5 profiles / F6 duplicates as needed.
